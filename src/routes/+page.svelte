...
<div class=" h-screen w-screen grid grid-cols-[16px_1fr_16px] grid-rows-[64px_200px_auto_auto_64px] gap-y-8  justify-items-center ">
    ...
    <div class=" col-start-2 row-start-4 self-end prose justify-center">
        ...
        <div class=" self-end  flex   gap-2 flex-wrap">
            <a href="https://www.instagram.com/josevonchong/"
            class="p-2 rounded-lg flex items-center border bg-primary   justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
        ...
        <a href="https://x.com/seispatines"
        class="p-2 rounded-lg flex items-center border bg-primary   justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
        ...
        <path
          ...
          fill="#111827" />
              ...
              <a href="https://pa.linkedin.com/in/josevonchong"
              class="p-2 rounded-lg flex items-center border bg-primary   justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72"
              fill="none">
              <path
              ...
              <a href="mailto:jvonchongr@gmail.com"
              class="p-2 rounded-lg flex items-center border bg-primary   justify-center transition-all duration-500 hover:border-gray-100 hover:bg-gray-100">
              <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 72 72"
              fill="none">
              <path
